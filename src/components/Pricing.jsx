...
const includedFeatures1 = [
  { feature: "5-20 users", included: true },
...
const includedFeatures2 = [
  { feature: "21-100 users", included: true },
...
const includedFeatures3 = [
  { feature: "100+ users", included: true },
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              >
                {includedFeatures1.map(({ feature, included }) => (
          ...
          <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <ul
                ...
                className="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-2 sm:gap-6"
              >
                {includedFeatures2.map(({ feature, included }) => (
                  <li key={feature} className="flex gap-x-3">
                    {included ? (
                      <CheckIcon
                        aria-hidden="true"
          ...
          <div className="mx-auto mt-16 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-20 lg:mx-0 lg:flex lg:max-w-none">
            <div className="p-8 sm:p-10 lg:flex-auto">
              ...
              <ul
                ...
                className="mt-8 grid grid-cols-1 gap-4 text-sm leading-6 text-gray-600 sm:grid-cols-2 sm:gap-6"
              >
                {includedFeatures3.map(({ feature, included }) => (
                  <li key={feature} className="flex gap-x-3">
                    {included ? (
                      <CheckIcon
                        aria-hidden="true"
